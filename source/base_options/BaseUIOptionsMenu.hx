...
class BaseUIOptionsMenu extends MusicBeatSubstate
{
	private var curOption:UIOption = null;
	private var curSelected:Int = 0;
	private var optionsArray:Array<UIOption>;
	...
	public function new()
	{
		...
		if(title == null) title = 'UI Options';
		if(rpcTitle == null) rpcTitle = 'UI Options Menu';
		...
		for (i in 0...optionsArray.length)
		{
			...
			if(optionsArray[i].type == 'bool') {
				...
				optionText.x -= 80;
				optionText.xAdd -= 80;
				var valueText:AttachedTextNew = new AttachedTextNew('' + optionsArray[i].getValue(), optionText.width + 80);
	...
	public function addOption(option:UIOption) {
	...
	override function update(elapsed:Float)
	{
		...
		if(nextAccept <= 0)
		{
			...
			if(controls.RESET)
			{
				for (i in 0...optionsArray.length)
				{
					var leOption:UIOption = optionsArray[i];
	...
	function updateTextFrom(option:UIOption) {
