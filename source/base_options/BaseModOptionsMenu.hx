...
{
	private var curOption:ModOption = null;
	private var curSelected:Int = 0;
	private var optionsArray:Array<ModOption>;
	...
	public function addOption(option:ModOption) {
	...
	override function update(elapsed:Float)
	{
		...
		if(nextAccept <= 0)
		{
			...
			if(controls.RESET)
			{
				for (i in 0...optionsArray.length)
				{
					var leOption:ModOption = optionsArray[i];
	...
	function updateTextFrom(option:ModOption) {
