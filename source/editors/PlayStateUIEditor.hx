...
class PlayStateUIEditor extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var trueBackground:FlxSprite = new FlxSprite().makeGraphic(FlxG.width * 2, FlxG.height * 2, FlxColor.WHITE);
		trueBackground.scrollFactor.set();
		trueBackground.screenCenter();
		add(trueBackground);
	...
	function updateMode()
	{
		...
		changeModeText.text = changeModeText.text;
